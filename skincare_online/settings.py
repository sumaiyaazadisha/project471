"""
Django settings for skincare_online project.
...
SECRET_KEY = 'django-insecure-werb@bl$06222-4r8c*5&=2f^t67_8z6x*4_+_e583-eddv^pp'
...
ROOT_URLCONF = 'skincare_online.urls'
...
WSGI_APPLICATION = 'skincare_online.wsgi.application'
